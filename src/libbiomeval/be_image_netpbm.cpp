    ...
    Error::ParameterError)
{
	...
	/* TODO: These are also defined in Image::Image::getRawGrayscaleData */
...
uint16_t
BiometricEvaluation::Image::NetPBM::valueInColorspace(
    uint16_t color,
    ...
    uint8_t depth)
{
	...
	return ((((uint16_t)pow(2.0, depth) - 1) * color) / maxColorValue);
}
