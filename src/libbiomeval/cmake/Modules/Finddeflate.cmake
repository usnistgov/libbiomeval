...
# --------
#
# Find the deflate headers and library.
#
# ::
#
#   deflate_* for all vars set by pkg_check_modules
#
# It also sets the target deflate::deflate
...
if (PkgConfig_FOUND)
    ...
    if(deflate_FOUND AND NOT TARGET deflate::deflate)
	    ...
	    target_link_libraries(deflate::deflate INTERFACE PkgConfig::deflate)
    endif()
endif()

find_package_handle_standard_args(deflate DEFAULT_MSG deflate_FOUND)
