...
const std::string
     BiometricEvaluation::IO::SQLiteRecordStore::Impl::KEY_COL = "key";
const std::string
     BiometricEvaluation::IO::SQLiteRecordStore::Impl::VALUE_COL = "value";
const std::string
     BiometricEvaluation::IO::SQLiteRecordStore::Impl::PRIMARY_KV_TABLE =
     "RecordStore";
const std::string
    BiometricEvaluation::IO::SQLiteRecordStore::Impl::SUBORDINATE_KV_TABLE =
...
BiometricEvaluation::IO::SQLiteRecordStore::Impl::Impl(
    const std::string &pathname,
    const std::string &description) :
    RecordStore::Impl(pathname, description, RecordStore::Kind::SQLite),
    _db(nullptr),
    _dbname(""),
    _sequencer(nullptr),
    _sequenceEnd(false)
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::move(
    const std::string &pathname)
{
...
uint64_t
BiometricEvaluation::IO::SQLiteRecordStore::Impl::getSpaceUsed()
    const
{
	this->sync();
	return (RecordStore::Impl::getSpaceUsed() + 
	    IO::Utility::getFileSize(this->_dbname));
}

void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::insert(
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::remove(
    const std::string &key)
{
	if (getMode() == Mode::ReadOnly)
		throw Error::StrategyError("RecordStore was opened read-only");
...
BiometricEvaluation::IO::SQLiteRecordStore::Impl::read(
    const std::string &key)
    const
{
...
uint64_t
BiometricEvaluation::IO::SQLiteRecordStore::Impl::length(
    const std::string &key)
    const
{
...
uint64_t
BiometricEvaluation::IO::SQLiteRecordStore::Impl::readSegments(
    const std::string &key,
    void * const data)
    const
{	
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::flush(
    const std::string &key)
    const
{
	if (!validateKeyString(key))
...
BiometricEvaluation::IO::SQLiteRecordStore::Impl::i_sequence(
    bool returnData,
    int cursor)
{
...
BiometricEvaluation::IO::RecordStore::Record
BiometricEvaluation::IO::SQLiteRecordStore::Impl::sequence(
    int cursor)
{
...
std::string
BiometricEvaluation::IO::SQLiteRecordStore::Impl::sequenceKey(
    int cursor)
{
	BiometricEvaluation::IO::RecordStore::Record record =
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::setCursorAtKey(
    const std::string &key)
{
	if (!validateKeyString(key))
		throw Error::StrategyError("Invalid key format");
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::cleanup()
{
	int32_t rv;
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::sqliteError(
    int32_t errorNumber)
    const
{	
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::createStructure()
{
...
void
BiometricEvaluation::IO::SQLiteRecordStore::Impl::createKeyValueTable(
...
bool
BiometricEvaluation::IO::SQLiteRecordStore::Impl::validateSchema()
{
...
bool
BiometricEvaluation::IO::SQLiteRecordStore::Impl::validateKeyValueTable(
    const std::string &table)
{
	sqlite3_stmt *statement;
...
std::string
BiometricEvaluation::IO::SQLiteRecordStore::Impl::getDBFilename() const
{
