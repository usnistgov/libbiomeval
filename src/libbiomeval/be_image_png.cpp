...
/**
 * @brief
 * Call messageHandler from libpng errors.
 *
 * @param png_ptr
 * Pointer to a PNG struct for the image.
 * @param msg
 ...
 *
 * @throw Error::StrategyError
 * Always thrown with msg, even if messageHandler won't
 */
static void
png_error_callback(
    png_structp png_ptr,
...
/**
 * @brief
 * Call messageHandler from libpng warnings.
 *
 * @param png_ptr
 * Pointer to a PNG struct for the image.
 * @param msg
    ...
    png_const_charp msg)
{
	...
	/*
	 * libpng cannot continue after errors, so if messageHandler won't
	 * throw, we will.
	 */
