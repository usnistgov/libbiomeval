...
\lstref{text-split} shows how to use the \code{split()} function from the
...
Notice the \code{true} parameter to \code{split()} in \lstref{text-split}.
...
shown in \lstref{text-digest}.  Changing the digest parameter to
