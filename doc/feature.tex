...
The data contained within a \class{Feature} object is represented as the ``native''
...
common for an application to retrieve these objects from the \class{AN2KView} object
