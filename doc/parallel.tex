...
\class{Distributor} classes are responsible for saving this state. As a
consequence, a distributor cannot record whether the work package was
actually processed.

A checkpoint is saved when the application enables the save capability via
...
Two optional parameters to the \class{Runtime} constructor control the
